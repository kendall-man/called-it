...
This worktree (`worktree-staging-mock`, **never merged into the submission**) runs the
...
- This branch is **staging-only**: mockline, seed data, and these scripts must never
  reach the hackathon submission. `main` stays clean.
