...
/**
 * Official txoracle IDL (v1.4.2) fetched from the on-chain IDL account of devnet
 * program 6pW64gN1s2uqjHkn1unFeEjAwJkPGHoppGvS715wyP2J on 2026-07-03
 * (anchor Program.fetchIdl against https://api.devnet.solana.com).
 *
 * DROP-IN POINT: if TxODDS publishes an updated IDL at
 * https://txline.txodds.com/documentation/programs/devnet, replace the object
 * literal below with the new JSON verbatim — nothing else needs to change.
 */
export const TXORACLE_IDL = {
  ...
  "instructions": [
    ...
    {
      "name": "sell_subscription_token_usdt",
      "discriminator": [
        188,
        208,
        146,
